...
export default function FloatingCTA() {
  return (
    <div className="fixed top-1/2 right-0 z-50 -translate-y-1/2 flex flex-col gap-3">
      ...
      {/* WhatsApp Button */}
      <Link
        href="https://wa.me/918097302413"
        target="_blank"
        rel="noopener noreferrer"
      >
        <button className="flex items-center  w-full gap-2 bg-[#25D366] text-white font-semibold px-3 py-4 rounded-l-lg shadow-lg hover:bg-[#1DA851] transition">
