          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full text-left flex justify-between items-center py-3 text-lg font-medium text-zinc-900 hover:text-teal-700 transition-colors"
              >
                <span
                  className={
                    openIndex === index
                ...
                <span
                  className={`transition-transform duration-300 ${
                    openIndex === index ? "rotate-180 text-teal-700" : ""
                  }`}
                >
                  ▼
                </span>
