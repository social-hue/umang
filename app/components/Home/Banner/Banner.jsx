...
export default function Banner() {
  ...
  return (
    <section className="w-full 2xl:h-[760px] xl:h-[580px] lg:h-[560px] md:h-[460px] h-[380px] relative overflow-hidden">
      <div className="relative w-full 2xl:h-[680px] xl:h-[500px] lg:h-[480px] md:h-[380px] h-[300px] overflow-hidden">
