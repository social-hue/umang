  ...
  return (
    <section className="main_width py-8 overflow-hidden">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-6 md:gap-10 mb-12">
          ...
          <div className="mt-4">
            ...
            <p className="text-zinc-700 text-lg leading-relaxed mb-6">
              ...
              RERA-compliant sales operations, and a proven property-management
              model that turns inventory into happy, long-term residents.
            </p>
        ...
        {/* CTA Section */}
        <div className="text-center md:py-6 mb-6 md:mb-2">
