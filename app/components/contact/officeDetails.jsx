  ...
  return (
    <section className="w-full bg-[#f9f9f9] py-10 px-6 md:px-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-center gap-12">
        {/* LEFT SIDE - MAP (60%) */}
        <div className="w-full md:w-[55%] h-[400px] md:h-[450px]">
          <iframe
        ...
        <div className="w-full md:w-[45%] flex flex-col justify-center gap-6 text-gray-800 h-full">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold text-zinc-800 flex items-center gap-2 mb-1">
