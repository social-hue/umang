          ...
          <div className="lg:text-[18px] text-[16px] text-white">
            <ul className="space-y-1">
              <li>
                ...
                <span className="sr-only">Checkmark:</span> A safe and welcoming environment
              </li>
              <li>
                <span className="text-white" aria-hidden="true">&#10004;</span>
                <span className="sr-only">Checkmark:</span> Professional healthcare and wellness support
              </li>
              <li>
                <span className="text-white" aria-hidden="true">&#10004;</span>
                <span className="sr-only">Checkmark:</span> Transparent communication & personalized care plans
              </li>
              <li>
                <span className="text-white" aria-hidden="true">&#10004;</span>
                <span className="sr-only">Checkmark:</span> Activities that foster social connections
              </li>
            </ul>
          </div>
